...
// ? 修复 1：修正原厂 typo，改为 DevAddr 与 .c 文件一致
...
// ? 修复 2：统一大写 TX_Buf，并增加我们新增的 EP3 通信通道！
extern __attribute__ ((aligned(16))) uint8_t USBHS_EP1_TX_Buf[ ];
extern __attribute__ ((aligned(16))) uint8_t USBHS_EP2_TX_Buf[ ];
extern __attribute__ ((aligned(16))) uint8_t USBHS_EP3_TX_Buf[ ];
extern __attribute__ ((aligned(16))) uint8_t USBHS_EP3_RX_Buf[ ];
